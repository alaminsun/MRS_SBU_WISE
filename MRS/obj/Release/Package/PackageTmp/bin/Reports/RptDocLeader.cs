...
namespace MRS.Reports {
    ...
    public class RptDocLeader : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "MRS.Reports.RptDocLeader.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptDocLeader : Component, ICachedReport {
        
        public CachedRptDocLeader() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptDocLeader rpt = new RptDocLeader();
            rpt.Site = this.Site;
            return rpt;
        }
